# Contributing to Idris-Crypto

Idris Hackers and those working specifically on `idris-crypto` welcomes pull requests, bug reporting, and bug squashing!
...
Before you report an issue, or wish to add cool functionality please try and check to see if there are existing [issues](https://github.com/idris-hackers/idris-crypto/issues) and [pull requests](https://github.com/idris-hackers/idris-crypto/pulls).
...
1. Fork our [main development repository](https://github.com/idris-hackers/idris-crypto) `idris-crypto` on github e.g.
2. Clone your fork to your local machine:

```
$ git clone git@github.com/<your github user name>/idris-crypto.git
```

3. Add `idris-hackers/idris-crypto` as a remote upstream

```
$ git remote add upstream git@github.com:idris-hackers/idrus-crypto.git
```
...
1. Go to GitHub and submit a pull request to `idris-crypto`

From there you will have to wait on one of the `idris-crypto` committers to respond to the request.
